                ...
                <Card>
                  <CardBody>
                    <CardTitle>Fees</CardTitle>
                      ...
                      <Button className="btn align-items-center" style={{ marginBottom: 40, backgroundColor: "#004852", borderColor: "#004852" }} onClick={toggleModal} >
            ...
            <Row className="mb-4">
                <Col lg="12">
                    <div className="d-flex align-items-center">
                        <div>
                        <Button className="btn align-items-center" style={{ padding: "12px 70px", marginBottom: 40, backgroundColor: "#004852", borderColor: "#004852" }}>
